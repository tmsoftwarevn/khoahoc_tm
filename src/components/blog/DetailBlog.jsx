...
const BlogItem = ({ item }) => {
  return (
    <div className="cursor-pointer flex justify-between items-start gap-4">
      <img src={item.img} alt="" className="img-fluid rounded" />
      <div className="ml-3">
        <h6 className="mb-2 text-base font-medium leading-tight hover:text-blue-600 duration-100">
          {item.title}
        </h6>
...
const SocialContent = () => (
  <div className="flex items-center lg:justify-between my-5 ">
    <div className="flex items-center">
      ...
      <div className="ml-3">August 10th, 2020</div>
    </div>
  </div>
);

const SideBar = () => (
  <div className="  rounded-t-lg py-4 px-3 mb-4">
    <h5 className="text-2xl uppercase font-semibold">Tin liên quan</h5>
...
const Blogdetails2 = () => {
  return (
    <section className="ezy__blogdetails2 light py-5 md:py-10">
