          ...
          <div className="col-span-12 lg:col-span-6 mb-6 lg:mb-0">
            <div className="relative">
              ...
              <p className="opacity-75 mb-2">
                ...
                nostrum a est voluptatibus. We want you to maintain a healthy
                work-life balance and encourage everyone to take a reasonable
                amount of time off. With our remote-first policy, you can set up
                shop from anywhere in the world and receive home office stipend.
              </p>
              <p className="opacity-75 mb-0">
                ...
                before unique process improvements. If you’ve wrapped up your
                work for the week, go ahead and start your weekend at 1:00pm on
                Fridays. You’re welcome. Ceros matches 25 cents for every
                pre-tax dollar contributed to your 401k, capped at $2,000 per
                year.
              </p>
            </div>
          </div>

          <div className="col-span-12 lg:col-span-6 grid justify-center items-center">
            <div className="border-[15px] border-transparent outline outline-[3px] outline-blue-600 rounded-full w-[300px] h-[300px] lg:w-[500px] lg:h-[500px] overflow-hidden">
              <img
            ...
            <section className="flex justify-center items-center mt-10 gap-5">
              ...
              <button
                href="/"
                class="group flex justify-center p-2 rounded-md drop-shadow-xl bg-black from-gray-800 text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1em"
